...
pathein_tmin_future %>%
  ...
  ggplot(aes(x = Year, y = Mean, color = Model)) +
  geom_line() +
  geom_line(data = pathein_tmin_future %>% mutate(Year = year(date)) %>% group_by(Model, Year) %>% summarize(Ob_mean = mean(Tmin.x)), aes(x = Year, y = Ob_mean), color = "maroon") +
  geom_line(aes(x = Year, y = Ob_mean), color = "darkolivegreen") +
  # geom_line(aes(x = Year, y = Max, color = Model), alpha = 0.5) +
  # geom_line(aes(x = Year, y = Min, color = Model), alpha = 0.5) +
  scale_color_manual(values = getpalette(colorcount)) +
...
colorcount <- length(unique(pathein_tmin_future_85$Model))
pathein_tmin_future_85 %>%
  group_by(Model, Year) %>%
  summarize(
    Mean = mean(future),
  ...
  ggplot(aes(x = Year, y = Mean, color = Model)) +
  geom_line() +
  geom_line(data = pathein_tmin_future_85 %>% mutate(Year = year(date)) %>% group_by(Model, Year) %>% summarize(Ob_mean = mean(Tmin.x)), aes(x = Year, y = Ob_mean), color = "grey60") +
  geom_line(aes(x =Year, y = Ob_mean), color = "grey60") +
...
pathein_tmin_future_85 %>%
  ...
  ggplot(aes(x = Year, y = Mean, color = Model)) +
  geom_line() +
  geom_line(data = pathein_tmin_future_85 %>% mutate(Year = year(date)) %>% group_by(Model, Year) %>% summarize(Ob_mean = mean(Tmin.x)), 
